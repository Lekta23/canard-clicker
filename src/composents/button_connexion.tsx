...
const ButtonConnexion = ({ label, className, onClick }: ButtonProps) => {
  return (
    <button
      onClick={onClick}
      type="button"
      className="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center absolute top-0 right-0 m-4 mr-2 mb-2 "
    >
      <svg
        aria-hidden="true"
